  ...
  return (
    <section className="flex justify-between items-center max-lg:flex-col gap-10 w-full max-container ">
      <div className="relative flex flex-1 flex-col ">
        ...
        <div className="-mt-36 absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 sm:gap-4 w-full lg:max-w-5xl">
